...
/* 704 */     return Objects.equals(c.getClientProperty(key), value);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 712 */     Object value = c.getClientProperty(key);
/* 713 */     return (value instanceof Boolean) ? ((Boolean)value).booleanValue() : defaultValue;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 721 */     Object value = c.getClientProperty(key);
/* 722 */     return (value instanceof Boolean) ? (Boolean)value : defaultValue;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 730 */     Object value = c.getClientProperty(key);
/* 731 */     return (value instanceof Integer) ? ((Integer)value).intValue() : defaultValue;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 739 */     Object value = c.getClientProperty(key);
/* 740 */     return (value instanceof Color) ? (Color)value : defaultValue;
/*     */   }
/*     */ }


/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/com/formdev/flatlaf/FlatClientProperties.class
