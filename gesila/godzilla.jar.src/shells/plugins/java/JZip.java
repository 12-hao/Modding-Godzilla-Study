...
/*     */       try {
/*  75 */         InputStream inputStream = getClass().getResourceAsStream(String.format("assets/%s.classs", new Object[] { "JZip" }));
/*  76 */         byte[] binCode = functions.readInputStream(inputStream);
/*  77 */         inputStream.close();
/*  78 */         this.loadState = this.payload.include("JZip", binCode);
...
/*  95 */       String resultString = this.encoding.Decoding(this.payload.evalFunc("JZip", "zip", reqParameter));
...
/* 107 */       String resultString = this.encoding.Decoding(this.payload.evalFunc("JZip", "unZip", reqParameter));
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/shells/plugins/java/JZip.class
