...
/*     */           continue;
/*     */         case 3:
/* 754 */           addNullToken(); return this.firstToken;
/*     */         case 24:
/*     */           continue;
/*     */         case 16:
...
/*     */           continue;
/*     */         case 5:
/* 808 */           addToken(38); addNullToken(); return this.firstToken;
/*     */         case 35:
/*     */           continue;
/*     */         case 6:
/* 812 */           addToken(37); addNullToken(); return this.firstToken;
/*     */         case 36:
/*     */           continue;
/*     */         case 10:
/* 816 */           temp1 = this.zzStartRead; temp2 = this.zzMarkedPos; addToken(this.start, this.zzStartRead - 1, 17); addToken(temp1, temp2 - 1, 1); addNullToken(); return this.firstToken;
/*     */         case 37:
/*     */           continue;
/*     */         case 17:
...
/*     */           continue;
/*     */         case 7:
/* 824 */           addToken(1); addNullToken(); return this.firstToken;
/*     */         case 39:
/*     */           continue;
/*     */         case 2:
...
/*     */           case 1:
/* 844 */             addToken(this.start, this.zzStartRead - 1, 17); addNullToken(); return this.firstToken;
/*     */           case 130:
/*     */             continue;
/*     */           case 0:
/* 848 */             addNullToken(); return this.firstToken;
/*     */           case 131:
/*     */             continue;
/*     */         } 
/* 852 */         return null;
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/ui/rsyntaxtextarea/modes/MakefileTokenMaker.class
