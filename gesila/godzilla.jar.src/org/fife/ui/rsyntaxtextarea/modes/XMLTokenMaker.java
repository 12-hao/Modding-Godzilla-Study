...
/* 428 */     return new XmlOccurrenceMarker();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */           continue;
/*     */         case 3:
/* 833 */           addNullToken(); return this.firstToken;
/*     */         case 33:
/*     */           continue;
/*     */         case 29:
...
/*     */           continue;
/*     */         case 9:
/* 856 */           addToken(this.start, this.zzStartRead - 1, 30); addEndToken(this.inInternalDtd ? -5 : -4); return this.firstToken;
/*     */         case 38:
/*     */           continue;
/*     */         case 16:
...
/*     */           continue;
/*     */         case 7:
/* 864 */           addToken(this.start, this.zzStartRead - 1, 29); addEndToken(-2048 - this.prevState); return this.firstToken;
/*     */         case 40:
/*     */           continue;
/*     */         case 5:
...
/*     */           continue;
/*     */         case 8:
/* 915 */           addToken(this.start, this.zzStartRead - 1, 31); return this.firstToken;
/*     */         case 52:
/*     */           continue;
/*     */         case 14:
...
/*     */           case 4:
/* 955 */             addToken(this.start, this.zzStartRead - 1, -3); return this.firstToken;
/*     */           case 78:
/*     */             continue;
/*     */           case 3:
/* 959 */             addToken(this.start, this.zzStartRead - 1, 30); addEndToken(this.inInternalDtd ? -5 : -4); return this.firstToken;
/*     */           case 79:
/*     */             continue;
/*     */           case 5:
/* 963 */             addToken(this.start, this.zzStartRead - 1, 28); addEndToken(-1); return this.firstToken;
/*     */           case 80:
/*     */             continue;
/*     */           case 0:
/* 967 */             addNullToken(); return this.firstToken;
/*     */           case 81:
/*     */             continue;
/*     */           case 1:
/* 971 */             addToken(this.start, this.zzStartRead - 1, 29); addEndToken(-2048 - this.prevState); return this.firstToken;
/*     */           case 82:
/*     */             continue;
/*     */           case 7:
/* 975 */             addToken(this.start, this.zzStartRead - 1, 33); return this.firstToken;
/*     */           case 83:
/*     */             continue;
/*     */           case 6:
/* 979 */             addToken(this.start, this.zzStartRead - 1, 28); addEndToken(-2); return this.firstToken;
/*     */           case 84:
/*     */             continue;
/*     */           case 2:
/* 983 */             addToken(this.start, this.zzStartRead - 1, 31); return this.firstToken;
/*     */           case 85:
/*     */             continue;
/*     */         } 
/* 987 */         return null;
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/ui/rsyntaxtextarea/modes/XMLTokenMaker.class
