...
/* 163 */                   icon.paintIcon(this, g, 0, y2);
/* 164 */                   lastLine = line - 1;
/*     */                 } 
/*     */               } 
...
/* 218 */         GutterIconInfo ti = getTrackingIcon(i);
/* 219 */         Icon icon = ti.getIcon();
/* 220 */         if (icon != null) {
/* 221 */           int iconH = icon.getIconHeight();
/* 222 */           int offs = ti.getMarkedOffset();
...
/* 230 */                   ti.getIcon().paintIcon(this, g, 0, y2);
/* 231 */                   lastLine = line - 1;
/*     */                 } 
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/ui/rsyntaxtextarea/FoldingAwareIconRowHeader.class
