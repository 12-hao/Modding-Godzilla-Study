...
/*  43 */   private static final EditorKit DEFAULT_KIT = new RSyntaxTextAreaEditorKit();
/*     */ 
/*     */   
/*     */   public static ComponentUI createUI(JComponent ta) {
/*  47 */     return new RSyntaxTextAreaUI(ta);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  90 */     return new RSyntaxTextAreaHighlighter();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (shared == null) {
/* 134 */       shared = new RSyntaxTextAreaDefaultInputMap();
/* 135 */       UIManager.put("RSyntaxTextAreaUI.inputMap", shared);
/*     */     } 
/*     */ 
/*     */ 
/*     */     
/* 140 */     map.setParent(shared);
/* 141 */     return map;
/*     */   }
/*     */ 
/*     */ 
...
/* 244 */     if (alloc != null) {
/* 245 */       RSTAView view = (RSTAView)getRootView(this.textArea).getView(0);
...
/* 261 */     if (alloc != null) {
/* 262 */       RSTAView view = (RSTAView)getRootView(this.textArea).getView(0);
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/ui/rsyntaxtextarea/RSyntaxTextAreaUI.class
