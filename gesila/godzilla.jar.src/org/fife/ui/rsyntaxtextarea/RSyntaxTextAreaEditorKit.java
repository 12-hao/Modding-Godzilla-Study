...
/*  142 */     return new RSyntaxDocument("text/plain");
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       } else {
/*      */         
/*  292 */         UIManager.getLookAndFeel().provideErrorFeedback(rsta);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*      */             try {
/*  375 */               String ws = RSyntaxUtilities.getLeadingWhitespace(doc, this.bracketInfo.y);
/*      */               
...
/*  417 */         UIManager.getLookAndFeel().provideErrorFeedback(textArea);
/*      */         
/*      */         return;
/*      */       } 
...
/*  455 */           UIManager.getLookAndFeel().provideErrorFeedback(rsta);
...
/*      */       } else {
/*      */         
/*  566 */         UIManager.getLookAndFeel().provideErrorFeedback(rsta);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*      */       } else {
/*      */         
/*  615 */         UIManager.getLookAndFeel().provideErrorFeedback(rsta);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*      */       } else {
/*      */         
/*  754 */         UIManager.getLookAndFeel().provideErrorFeedback(rsta);
/*      */       } 
/*      */     }
/*      */   }
/*      */ 
...
/*  785 */         UIManager.getLookAndFeel().provideErrorFeedback(textArea);
/*      */         
/*      */         return;
/*      */       } 
...
/*  824 */             .provideErrorFeedback(textArea);
/*      */         } finally {
...
/*  836 */             .provideErrorFeedback(textArea);
/*      */         } 
/*      */       } 
/*      */     }
/*      */ 
...
/*      */       } else {
/*      */         
/* 1211 */         UIManager.getLookAndFeel().provideErrorFeedback(rsta);
/*      */       } 
/*      */     }
/*      */     
...
/*      */       } else {
/*      */         
/* 1307 */         UIManager.getLookAndFeel().provideErrorFeedback(rsta);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/*      */       } else {
/*      */         
/* 1409 */         UIManager.getLookAndFeel().provideErrorFeedback(rsta);
/*      */       } 
/*      */     }
/*      */   }
/*      */ 
...
/* 1631 */         UIManager.getLookAndFeel().provideErrorFeedback(textArea);
/*      */         
/*      */         return;
/*      */       } 
...
/* 1681 */             .provideErrorFeedback(textArea);
/*      */         } finally {
...
/* 1830 */               .provideErrorFeedback(textArea);
/*      */           
/*      */           }
/*      */ 
/*      */         
...
/* 1966 */       this.start = new RSyntaxTextAreaEditorKit.BeginWordAction("pigdog", false);
/* 1967 */       this.end = new RSyntaxTextAreaEditorKit.EndWordAction("pigdog", true);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1987 */         UIManager.getLookAndFeel().provideErrorFeedback(textArea);
/*      */         
/*      */         return;
/*      */       } 
...
/* 2006 */         UIManager.getLookAndFeel().provideErrorFeedback(textArea);
/*      */ 
/*      */         
/*      */         return;
/*      */       } 
...
/*      */       try {
/* 2021 */         boolean add = getDoAdd(doc, map, start, end, startEnd);
/* 2022 */         for (line1 = start; line1 <= end; line1++) {
/* 2023 */           Element elem = map.getElement(line1);
/* 2024 */           handleToggleComment(elem, doc, startEnd, add);
/*      */         } 
/* 2026 */       } catch (BadLocationException ble) {
/* 2027 */         ble.printStackTrace();
/* 2028 */         UIManager.getLookAndFeel().provideErrorFeedback(textArea);
/*      */       } finally {
...
/*      */       } else {
/*      */         
/* 2107 */         UIManager.getLookAndFeel().provideErrorFeedback(rsta);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/ui/rsyntaxtextarea/RSyntaxTextAreaEditorKit.class
