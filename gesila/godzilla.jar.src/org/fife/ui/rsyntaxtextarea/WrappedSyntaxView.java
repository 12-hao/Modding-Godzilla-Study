...
/*      */ 
/*      */       
/*  270 */       h.paintParserHighlights(g, p0, p, r, this.host, this);
/*      */       
/*  272 */       p0 = (p == p0) ? p1 : p;
/*  273 */       y += fontHeight;
/*      */     } 
...
/*      */     
/*  319 */     setSegment(p0, p1 - 1, document, this.drawSeg);
/*      */     
...
/*  328 */       h.paintLayeredHighlights(g, p0, p1, r, this.host, this);
/*      */       
/*      */       return;
/*      */     } 
/*      */     
...
/*  336 */       x = r.x;
/*      */       
/*  338 */       h.paintLayeredHighlights(g, p0, p, r, this.host, this);
/*      */       
...
/*      */ 
/*      */       
/*  473 */       h.paintParserHighlights(g, p0, p, r, this.host, this);
/*      */       
/*  475 */       p0 = (p == p0) ? p1 : p;
/*  476 */       y += fontHeight;
/*      */     } 
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/ui/rsyntaxtextarea/WrappedSyntaxView.class
