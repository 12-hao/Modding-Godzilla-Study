...
/*  461 */       Window parent = SwingUtilities.getWindowAncestor(this);
...
/*  507 */     this.foldingMenu.add(createPopupMenuItem(toggleCurrentFoldAction));
/*  508 */     this.foldingMenu.add(createPopupMenuItem(collapseAllCommentFoldsAction));
/*  509 */     this.foldingMenu.add(createPopupMenuItem(collapseAllFoldsAction));
/*  510 */     this.foldingMenu.add(createPopupMenuItem(expandAllFoldsAction));
...
/*  689 */     return new RSyntaxDocument("text/plain");
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  737 */     return new RSyntaxTextAreaMutableCaretEvent(this);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  786 */     return new RSyntaxTextAreaUI(this);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  932 */     firePropertyChange("RSTA.markedOccurrencesChanged", (Object)null, (Object)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  942 */     firePropertyChange("RSTA.parserNotices", (Object)null, (Object)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1909 */           this.focusableTip = new FocusableTip(this, this.parserManager);
/*      */         }
...
/*      */     
/* 2008 */     this.foldManager = new DefaultFoldManager(this);
/*      */ 
/*      */     
...
/*      */ 
/*      */       
/* 2149 */       SyntaxView sv = (SyntaxView)getUI().getRootView(this).getView(0);
...
/*      */       }
/*      */       
/* 3266 */       Window window = SwingUtilities.getWindowAncestor(RSyntaxTextArea.this);
...
/* 3534 */                 UIManager.getLookAndFeel().provideErrorFeedback(this.textArea);
...
/* 3542 */     Container container = this;
/* 3543 */     while ((container = container.getParent()) != null) {
...
/* 3551 */     Container container = this;
/* 3552 */     while ((container = container.getParent()) != null) {
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/ui/rsyntaxtextarea/RSyntaxTextArea.class
