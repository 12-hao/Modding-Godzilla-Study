...
/* 191 */     if (t == null) {
/* 192 */       UIManager.getLookAndFeel().provideErrorFeedback(textArea);
/* 193 */       return this.completions;
/*     */     } 
/*     */     
/* 196 */     int desiredType = getDesiredTokenType(t, dot);
/* 197 */     if (desiredType == 0) {
/* 198 */       UIManager.getLookAndFeel().provideErrorFeedback(textArea);
...
/* 210 */         tagNameToken = new TokenImpl(tagNameToken);
/* 211 */         words = collectCompletionWordsAttribute(doc, tagNameToken, currentWordStart);
/*     */       }
/*     */       else {
/*     */         
/* 215 */         UIManager.getLookAndFeel().provideErrorFeedback(textArea);
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/rsta/ac/xml/XmlCompletionProvider.class
