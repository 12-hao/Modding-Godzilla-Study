...
/*     */     
/* 166 */     DefaultParseResult result = new DefaultParseResult(this);
...
/*     */       }
/* 182 */       DocumentReader r = new DocumentReader(doc);
/* 183 */       InputSource input = new InputSource(r);
...
/*     */       }
/*     */       
/* 268 */       DefaultParserNotice pn = new DefaultParserNotice(XmlParser.this, e.getMessage(), line, offs, len);
/* 269 */       pn.setLevel(level);
/* 270 */       this.result.addNotice(pn);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/rsta/ac/xml/XmlParser.class
