...
/*  88 */     this.result = new DefaultParseResult(this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 146 */       this.result.addNotice(new DefaultParserNotice(this, msg, 0));
...
/* 172 */         DefaultParserNotice notice = new DefaultParserNotice(this, desc, line, offs, len);
/*     */         
/* 174 */         if (problem.getType() == ParseProblem.Type.Warning) {
/* 175 */           notice.setLevel(ParserNotice.Level.WARNING);
/*     */         }
/* 177 */         this.result.addNotice(notice);
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     
/* 246 */     DocumentReader r = new DocumentReader(doc);
...
/* 252 */       this.astRoot = parser.parse(r, null, 0);
...
/* 266 */       this.result.addNotice(new DefaultParserNotice(this, msg, line, offs, len));
/*     */     }
...
/*     */         
/* 288 */         return this.result;case JSHINT: break; }  gatherParserErrorsJsHint(doc); this.support.firePropertyChange("AST", (Object)null, this.astRoot); return this.result;
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/rsta/ac/js/JavaScriptParser.class
