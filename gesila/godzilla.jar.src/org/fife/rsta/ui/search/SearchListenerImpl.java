...
/*    */       
/*    */       default:
/* 26 */         result = SearchEngine.markAll(this.textArea, context);
/*    */         break;
/*    */       case FIND:
/* 29 */         result = SearchEngine.find(this.textArea, context);
/* 30 */         if (!result.wasFound() || result.isWrapped()) {
/* 31 */           UIManager.getLookAndFeel().provideErrorFeedback(this.textArea);
/*    */         }
/*    */         break;
/*    */       case REPLACE:
/* 35 */         result = SearchEngine.replace(this.textArea, context);
/* 36 */         if (!result.wasFound() || result.isWrapped()) {
/* 37 */           UIManager.getLookAndFeel().provideErrorFeedback(this.textArea);
/*    */         }
/*    */         break;
/*    */       case REPLACE_ALL:
/* 41 */         result = SearchEngine.replaceAll(this.textArea, context);
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/fife/rsta/ui/search/SearchListenerImpl.class
