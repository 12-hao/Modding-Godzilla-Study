...
/*     */       default:
/*     */         try {
/*  83 */           for (PropertyDescriptor property : Introspector.getBeanInfo(type)
/*  84 */             .getPropertyDescriptors()) {
/*  85 */             Method readMethod = property.getReadMethod();
/*  86 */             if ((readMethod == null || !readMethod.getName().equals("getClass")) && 
/*  87 */               !isTransient(property)) {
...
/* 158 */       throw new YAMLException("Unable to find property '" + name + "' on class: " + type
/* 159 */           .getName());
/*     */     }
/* 161 */     return property;
/*     */   }
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/yaml/snakeyaml/introspector/PropertyUtils.class
