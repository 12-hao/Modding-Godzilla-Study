...
/*     */           
/* 172 */           tuple = new ImplicitTuple(node.getTag().equals(detectedTag), node.getTag().equals(defaultTag));
/*     */           
/* 174 */           event = new ScalarEvent(tAlias, node.getTag().getValue(), tuple, scalarNode.getValue(), null, null, scalarNode.getScalarStyle());
...
/*     */           
/* 184 */           this.emitter.emit((Event)new SequenceStartEvent(tAlias, node.getTag().getValue(), implicitS, null, null, seqNode
/* 185 */                 .getFlowStyle()));
...
/* 201 */         this.emitter.emit((Event)new MappingStartEvent(tAlias, mnode.getTag().getValue(), implicitM, null, null, mnode
/* 202 */               .getFlowStyle()));
...
/*     */       
/* 223 */       CommentEvent commentEvent = new CommentEvent(line.getCommentType(), line.getValue(), line.getStartMark(), line.getEndMark());
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/yaml/snakeyaml/serializer/Serializer.class
