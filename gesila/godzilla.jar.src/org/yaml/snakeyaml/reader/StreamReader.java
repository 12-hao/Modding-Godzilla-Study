...
/* 114 */       this.index++;
/* 115 */       if (Constant.LINEBR.has(c) || (c == 13 && 
/* 116 */         ensureEnoughData() && this.dataWindow[this.pointer] != 10)) {
/* 117 */         this.line++;
/* 118 */         this.column = 0;
/* 119 */       } else if (c != 65279) {
/* 120 */         this.column++;
...
/*     */     }
/* 151 */     return new String(this.dataWindow, this.pointer, 
/* 152 */         Math.min(length, this.dataLength - this.pointer));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/yaml/snakeyaml/reader/StreamReader.class
