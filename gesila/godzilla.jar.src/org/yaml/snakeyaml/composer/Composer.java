...
/* 165 */         throw new ComposerException(null, null, "found undefined alias " + anchor, event
/* 166 */             .getStartMark());
/*     */       }
...
/* 201 */       nodeTag = this.resolver.resolve(NodeId.scalar, ev.getValue(), ev
/* 202 */           .getImplicit().canOmitTagInPlainScalar());
/* 203 */       resolved = true;
/*     */     } else {
/* 205 */       nodeTag = new Tag(tag);
/*     */     } 
/*     */     
/* 208 */     ScalarNode scalarNode = new ScalarNode(nodeTag, resolved, ev.getValue(), ev.getStartMark(), ev.getEndMark(), ev.getScalarStyle());
/* 209 */     if (anchor != null) {
...
/*     */     
/* 232 */     SequenceNode node = new SequenceNode(nodeTag, resolved, children, startEvent.getStartMark(), null, startEvent.getFlowStyle());
...
/*     */     
/* 273 */     MappingNode node = new MappingNode(nodeTag, resolved, children, startEvent.getStartMark(), null, startEvent.getFlowStyle());
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/yaml/snakeyaml/composer/Composer.class
