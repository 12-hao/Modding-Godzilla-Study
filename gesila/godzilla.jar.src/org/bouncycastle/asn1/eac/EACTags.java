...
public class EACTags {
  ...
  public static int getTagNo(int paramInt) {
    for (byte b = 24; b >= 0; b -= 8) {
      if ((255 << b & paramInt) != 0)
        return (255 << b ^ 0xFFFFFFFF) & paramInt; 
    } 
    return 0;
  }
  
  public static int encodeTag(ASN1ApplicationSpecific paramASN1ApplicationSpecific) {
    int i = 64;
    boolean bool = paramASN1ApplicationSpecific.isConstructed();
    if (bool)
      i |= 0x20; 
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/bouncycastle/asn1/eac/EACTags.class
