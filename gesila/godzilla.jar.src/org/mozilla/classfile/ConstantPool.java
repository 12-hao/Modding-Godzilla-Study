...
/* 4727 */     this.itsStringConstHash = new UintMap();
/* 4728 */     this.itsUtf8Hash = new ObjToIntMap();
/* 4729 */     this.itsFieldRefHash = new ObjToIntMap();
/* 4730 */     this.itsMethodRefHash = new ObjToIntMap();
/* 4731 */     this.itsClassHash = new ObjToIntMap();
/*      */ 
/*      */ 
/*      */     
/* 4735 */     this.itsConstantData = new UintMap();
/* 4736 */     this.itsPoolTypes = new UintMap();
/*      */     this.cfw = cfw;
/*      */     this.itsTopIndex = 1;
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/mozilla/classfile/ConstantPool.class
