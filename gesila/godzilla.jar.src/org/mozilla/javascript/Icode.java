...
/* 143 */     if (!validBytecode(bytecode)) {
/* 144 */       throw new IllegalArgumentException(String.valueOf(bytecode));
/*     */     }
/*     */ 
/*     */     
/* 148 */     return String.valueOf(bytecode);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 228 */     return (-64 <= icode && icode <= 0);
/*     */   }
/*     */ 
/*     */   
/*     */   static boolean validTokenCode(int token) {
/* 233 */     return (2 <= token && token <= 80);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   static boolean validBytecode(int bytecode) {
/* 239 */     return (validIcode(bytecode) || validTokenCode(bytecode));
/*     */   }
/*     */ }


/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/mozilla/javascript/Icode.class
