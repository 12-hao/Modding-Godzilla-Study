...
/* 52 */     int kQ = 64;
/* 53 */     double k = Math.ceil((alpha - e + kQ - 1) * 0.30102999566398114D);
/* 54 */     int index = (308 + (int)k - 1) / 8 + 1;
