...
/*  18 */   private static final Object GENERATOR_TAG = "Generator"; private static final int MAX_PROTOTYPE_ID = 5; private NativeFunction function; private Object savedState;
...
/*  25 */     NativeGenerator prototype = new NativeGenerator();
/*  26 */     if (scope != null) {
/*  27 */       prototype.setParentScope(scope);
/*  28 */       prototype.setPrototype(getObjectPrototype(scope));
/*     */     } 
/*  30 */     prototype.activatePrototypeMap(5);
/*  31 */     if (sealed) {
/*  32 */       prototype.sealObject();
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 241 */     this.firstTime = true; } public NativeGenerator(Scriptable scope, NativeFunction function, Object savedState) { this.firstTime = true;
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/mozilla/javascript/NativeGenerator.class
