...
/*   42 */   private static final Object REGEXP_TAG = new Object();
...
/*  116 */     NativeRegExp proto = new NativeRegExp();
/*  117 */     proto.re = compileRE(cx, "", (String)null, false);
/*  118 */     proto.activatePrototypeMap(6);
/*  119 */     proto.setParentScope(scope);
/*  120 */     proto.setPrototype(getObjectPrototype(scope));
/*      */     
/*  122 */     NativeRegExpCtor ctor = new NativeRegExpCtor();
/*      */ 
/*      */     
/*  125 */     proto.defineProperty("constructor", ctor, 2);
/*      */     
/*  127 */     ScriptRuntime.setFunctionProtoAndParent(ctor, scope);
/*      */     
/*  129 */     ctor.setImmunePrototypeProperty(proto);
/*      */     
/*  131 */     if (sealed) {
/*  132 */       proto.sealObject();
/*  133 */       ctor.sealObject();
/*      */     } 
/*      */     
/*  136 */     defineProperty(scope, "RegExp", ctor, 2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 2778 */     this.lastIndex = Double.valueOf(0.0D);
/* 2779 */     this.lastIndexAttr = 6; this.re = regexpCompiled; this.lastIndex = Double.valueOf(0.0D); ScriptRuntime.setBuiltinProtoAndParent((ScriptableObject)this, scope, TopLevel.Builtins.RegExp); } NativeRegExp() { this.lastIndex = Double.valueOf(0.0D); this.lastIndexAttr = 6; }
/*      */ 
/*      */   
...
/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/mozilla/javascript/regexp/NativeRegExp.class
