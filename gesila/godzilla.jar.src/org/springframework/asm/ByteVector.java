...
/* 355 */     if (this.length > this.data.length) {
/* 356 */       throw new AssertionError("Internal error");
/*     */     }
/* 358 */     int doubleCapacity = 2 * this.data.length;
/* 359 */     int minimalCapacity = this.length + size;
/* 360 */     byte[] newData = new byte[(doubleCapacity > minimalCapacity) ? doubleCapacity : minimalCapacity];
/* 361 */     System.arraycopy(this.data, 0, newData, 0, this.length);
/* 362 */     this.data = newData;
/*     */   }
/*     */ }


/* Location:              /Users/h12/Documents/网安工具/gesila/godzilla.jar!/org/springframework/asm/ByteVector.class
